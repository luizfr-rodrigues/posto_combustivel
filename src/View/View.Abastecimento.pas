...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.StdCtrls, Vcl.Buttons, Vcl.ExtCtrls, Model.Abastecimento;
...
const
  NUMERO_DIGITOS_QTDE = 3;
  NUMERO_DIGITOS_VALOR = 3;
...
begin
  FAbastecimento.Bomba.ConsultarPorId(AId_Bomba);
